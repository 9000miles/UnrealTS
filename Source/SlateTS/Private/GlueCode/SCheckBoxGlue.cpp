...
namespace $SCheckBox
{
	static void $Arguments(const v8::FunctionCallbackInfo<v8::Value>& Info, uint8 ArgumentsIndex, v8::Local<v8::Context> Context, v8::Isolate* Isolate, SCheckBox::FArguments& Arguments)
	{
		...
		SET_VARIABLE__SLATE_ARGUMENT(CheckBoxContentUsesAutoWidth);
		...
		SET_VARIABLE__SLATE_ARGUMENT(CheckedSoundOverride);
		SET_VARIABLE__SLATE_ARGUMENT(UncheckedSoundOverride);
		SET_VARIABLE__SLATE_ARGUMENT(HoveredSoundOverride);
		SET_VARIABLE__SLATE_ARGUMENT(UncheckedImage);
		SET_VARIABLE__SLATE_ARGUMENT(UncheckedHoveredImage);
		SET_VARIABLE__SLATE_ARGUMENT(UncheckedPressedImage);
		SET_VARIABLE__SLATE_ARGUMENT(CheckedImage);
		SET_VARIABLE__SLATE_ARGUMENT(CheckedHoveredImage);
		SET_VARIABLE__SLATE_ARGUMENT(CheckedPressedImage);
		SET_VARIABLE__SLATE_ARGUMENT(UndeterminedImage);
		SET_VARIABLE__SLATE_ARGUMENT(UndeterminedHoveredImage);
		SET_VARIABLE__SLATE_ARGUMENT(UndeterminedPressedImage);
		SET_VARIABLE__SLATE_ARGUMENT(BackgroundImage);
		SET_VARIABLE__SLATE_ARGUMENT(BackgroundHoveredImage);
		SET_VARIABLE__SLATE_ARGUMENT(BackgroundPressedImage);
	}

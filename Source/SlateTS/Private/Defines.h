...
#define REGISTER_WIDGET_ARGUMENT_TYPE__Style(Type)								Arguments.Add("Style", "UE.CheckBoxStyle", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__Type(Type)								Arguments.Add("Type", "UE.ESlateCheckBoxType", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__CheckBoxContentUsesAutoWidth(Type)		Arguments.Add("CheckBoxContentUsesAutoWidth", TS_boolean, Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__IsChecked(Type)							Arguments.Add("IsChecked", "UE.ECheckBoxState", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__CheckedSoundOverride(Type)				Arguments.Add("CheckedSoundOverride", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__UncheckedSoundOverride(Type)				Arguments.Add("UncheckedSoundOverride", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__UncheckedImage(Type)						Arguments.Add("UncheckedImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__UncheckedHoveredImage(Type)				Arguments.Add("UncheckedHoveredImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__UncheckedPressedImage(Type)				Arguments.Add("UncheckedPressedImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__CheckedImage(Type)						Arguments.Add("CheckedImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__CheckedHoveredImage(Type)				Arguments.Add("CheckedHoveredImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__CheckedPressedImage(Type)				Arguments.Add("CheckedPressedImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__UndeterminedImage(Type)					Arguments.Add("UndeterminedImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__UndeterminedHoveredImage(Type)			Arguments.Add("UndeterminedHoveredImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__UndeterminedPressedImage(Type)			Arguments.Add("UndeterminedPressedImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__BackgroundImage(Type)					Arguments.Add("BackgroundImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__BackgroundHoveredImage(Type)				Arguments.Add("BackgroundHoveredImage", "UE.SlateBrush", Type)
#define REGISTER_WIDGET_ARGUMENT_TYPE__BackgroundPressedImage(Type)				Arguments.Add("BackgroundPressedImage", "UE.SlateBrush", Type)
